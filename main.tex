...
\pkuthssinfo{
    cthesisname = {一个说长不长说短不短的中文题目}, %
    thesiscover = {本科生毕业论文},
    ethesisname = {An English Title That is Neither Particularly Long nor Particularly Short},
    ctitle = {一个说长不长说短不短的中文题目},
    etitle = {\textbf{An English Title That is Neither Particularly Long nor Particularly Short}},
    cauthor = {艾斯伊兹}, eauthor = {icez},
    studentid = {210001XXXX},
    % 具体时间以教务为准，初稿3月，送审4月，答辩5月，最终6月。
    date = {\zhdigits{2025}\heiti{年\zhnumber{5}月}},
    school = {信息科学技术学院},
    cmajor = {自学与开源科学}, emajor = {这个字段不会被显示},
    direction = {这个字段不会被显示},
    mentorlines = {1}, % 导师个数
    cmentor = {ChatGPT}, ementor = {这个字段不会被显示},
    ckeywords = {A，B，C，D},
    ekeywords = {A,B,C,D},
